        ...
        <Dialog visible={showGuide} onDismiss={() => setShowGuide(false)}>
          ...
          <Dialog.Content>
            <Text style={{ fontSize: 15, lineHeight: 22 }}>
              Let’s check your{' '}
              <Text style={{ fontWeight: 'bold' }}>Left eye vision</Text>.
              {'\n\n'}• Cover your{' '}
              <Text style={{ fontWeight: 'bold' }}>Right eye</Text> with your
              hand without pressing your eyelid tightly.{'\n\n'}• If you're
              wearing glasses, cover your eye{' '}
